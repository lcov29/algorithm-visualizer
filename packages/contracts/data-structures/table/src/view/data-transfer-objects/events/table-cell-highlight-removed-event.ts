...
interface ITableCellHighlightRemovedEventArgs {
  rowId: number;
  columnId: number;
}

export class TableCellHighlightRemovedEvent extends BaseEvent<'table-cell-highlight-removed'> {
  private _rowId: number;
  private _columnId: number;

  constructor(args: ITableCellHighlightRemovedEventArgs) {
    super('table-cell-highlight-removed');
